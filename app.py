...
API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZjMwMDI2ODBAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.L6Vc_i-j1fQqeuIiCiKZ3StlkFJF5LDCUWMUfH1Ug3w"#os.getenv("API_KEY")  # Get API key from environment variable
